...
plot(z_position,y_temp,'bo','linewidth',2);%z_position
hold on
xdata1=z_position(2:12);ydata1=y_temp(2:12);
pn=polyfit(xdata1,ydata1,1);
x_interpo1=12:1:z_interface;
y_interpo1=polyval(pn,x_interpo1);
plot(x_interpo1,y_interpo1,'-r','linewidth',1.5)

hold on
xdata2=z_position(16:end-2);ydata2=y_temp(16:end-2);
pn=polyfit(xdata2,ydata2,1);
x_interpo2=z_interface:1:400;
y_interpo2=polyval(pn,x_interpo2);
plot(x_interpo2,y_interpo2,'-r','linewidth',1.5)
hold on
% plot([z_interface z_interface],[280 320])
xlabel('Z position (A)','fontsize',font_size);
ylabel('T (K)','fontsize',font_size);
set(gca,'fontsize',font_size);
title('(a)');
temp_difference2=y_interpo1(end)-y_interpo2(1);
% ylim([280 320])
