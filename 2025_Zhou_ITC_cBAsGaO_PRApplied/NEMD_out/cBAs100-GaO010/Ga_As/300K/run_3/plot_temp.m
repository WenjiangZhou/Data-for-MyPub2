...
xinter1=12:1:z_interface;
yinter1=polyval(pn,xinter1);
plot(xinter1,yinter1,'-r','linewidth',1.5)
hold on
xdata2=z_position(15:end-1);ydata2=y_temp(15:end-1);
pn=polyfit(xdata2,ydata2,1);
xinter2=z_interface:1:400;
yinter2=polyval(pn,xinter2);
plot(xinter2,yinter2,'-r','linewidth',1.5)
xlabel('Z position (A)','fontsize',font_size);
ylabel('T (K)','fontsize',font_size);
set(gca,'fontsize',font_size);
title('(a)');
temp_difference2=-yinter2(1)+yinter1(end);
